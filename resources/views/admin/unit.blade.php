...
@section('title',' - Unit')
@section('content')
    <button type="button" class="btn btn-primary mb-2 float-end" data-bs-toggle="modal" data-bs-target="#unitModal">+ Add Unit</button>
            ...
            <tr>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <li><a class="dropdown-item text-danger deleteUnit" style="cursor: pointer" data-bs-toggle="modal" data-bs-target="#categoryDelete"><i class="bi bi-trash-fill"></i>Delete</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
    ...
    {{$unit->links()}}
     ...
     <div class="modal fade" id="categoryEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="/admin/edit-unit" method="post">
            @csrf
            <table class="w-100">
                <tr class="align-top">
                    <th>ID</th>
